    ...
    <>
        ...
        <div className='relative -mt-28'> {/* Added padding-top instead of negative margin-top */}
            <div className='flex flex-col justify-center space-x-4 items-center mt-8'> {/* Removed negative margin-top and adjusted for center alignment */}
                ...
                <button onClick={openModal} className='primary-btn mt-10 w-44 transition duration-500 hover:-translate-y-1'>Refer A Friend</button>
            </div>
        </div>
        {isModalOpen && (
                    ...
                    <div className="overflow-y-auto h-full">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <input 
                                ...
                                required className="block w-full p-2 border focus:outline-primary border-gray-300 rounded-md" />
                            ...
                            <textarea placeholder="Example 1" required className="block w-full p-2 border focus:outline-primary border-gray-300 rounded-md resize-none h-24" />
                            <textarea placeholder="Example 2" required className="block w-full p-2 border focus:outline-primary border-gray-300 rounded-md resize-none h-24" />
                            <textarea placeholder="Example 3" required className="block w-full p-2 border focus:outline-primary border-gray-300 rounded-md resize-none h-24" />

                            <div className="flex flex-col space-y-2">
                                <label className="font-medium text-sm">
                                    I understand that by submitting this form I am stating that I feel this candidate has the characteristics that CFA Cap Centre or Steeplechase are looking for in future Team Members: 
