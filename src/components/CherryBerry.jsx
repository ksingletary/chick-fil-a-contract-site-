...
const CherryBerry = () => {
  return (
    <>
        <LazyBackground src={('../../assets/cherryBerryComponent.jpeg')} className='background-image-cherryBerry min-h-screen flex justify-center items-center'>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-6'>
                    ...
                    <div className='flex justify-center items-center'>
                        <LazyImage
                            src={cherryberrylem}
                            alt="cfa image"
                            className='max-w-[750px] w-full mx-auto shadow-strong rounded-lg'
                        />
                    </div>
                    {/* Text content section */}
