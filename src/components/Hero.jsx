            ...
            <div className='container'>
                ...
                <div className='flex justify-center items-center space-x-8 mt-4'>
                    <a href="https://www.chick-fil-a.com/one">
                        <button className="bg-primary hover:bg-red-800 text-white font-bold py-3 px-6 rounded-full shadow-lg">
                            Earn Rewards with Our App
                        </button>
                    </a>
                    <Link to="/about">
                        <button className="bg-secondary hover:bg-gray-800 text-white font-bold py-3 px-6 rounded-full shadow-lg">
